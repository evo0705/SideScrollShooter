...
class MultitouchInputMode_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("openfl.ui.MultitouchInputMode","\xeb","\xaa","\xbf","\xb3"); }
		::String __ToString() const { return HX_HCSTRING("MultitouchInputMode.","\x67","\x5d","\x70","\xfb") + tag; }
