...
class HXCPP_CLASS_ATTRIBUTES  FlxSpriteGroup_obj : public ::flixel::group::FlxTypedSpriteGroup_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="flixel.group.FlxSpriteGroup")
		...
		::String __ToString() const { return HX_HCSTRING("FlxSpriteGroup","\xc8","\x4d","\x1f","\x2f"); }
