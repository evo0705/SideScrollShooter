...
class HXCPP_CLASS_ATTRIBUTES  FlxColorUtil_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="flixel.util.FlxColorUtil")
		...
		::String __ToString() const { return HX_HCSTRING("FlxColorUtil","\x53","\x2c","\x04","\x46"); }
