...
class HXCPP_CLASS_ATTRIBUTES  GraphicX_obj : public ::openfl::_legacy::display::BitmapData_obj{
	public:
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="flixel.ui._FlxVirtualPad.GraphicX")
		...
		::String __ToString() const { return HX_HCSTRING("GraphicX","\xd0","\xb4","\x19","\xec"); }
