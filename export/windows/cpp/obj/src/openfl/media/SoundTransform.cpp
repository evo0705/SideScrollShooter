...
::openfl::media::SoundTransform SoundTransform_obj::clone( ){
	HX_STACK_FRAME("openfl.media.SoundTransform","clone",0xa03c86d4,"openfl.media.SoundTransform.clone","openfl/media/SoundTransform.hx",67,0xcbc8f637)
	HX_STACK_THIS(this)
	HX_STACK_LINE(69)
...
bool SoundTransform_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void SoundTransform_obj::__register()
{
	...
	__mClass->mSetStaticField = &SoundTransform_obj::__SetStatic;
