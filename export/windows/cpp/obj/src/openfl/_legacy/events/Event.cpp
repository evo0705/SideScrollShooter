...
bool Event_obj::__getIsCancelled( ){
	HX_STACK_FRAME("openfl._legacy.events.Event","__getIsCancelled",0x715efeb6,"openfl._legacy.events.Event.__getIsCancelled","openfl/_legacy/events/Event.hx",114,0xcca9b1d4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(116)
	bool tmp = this->__isCancelled;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(116)
...
bool Event_obj::__getIsCancelledNow( ){
	HX_STACK_FRAME("openfl._legacy.events.Event","__getIsCancelledNow",0x9a1c2800,"openfl._legacy.events.Event.__getIsCancelledNow","openfl/_legacy/events/Event.hx",121,0xcca9b1d4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(123)
