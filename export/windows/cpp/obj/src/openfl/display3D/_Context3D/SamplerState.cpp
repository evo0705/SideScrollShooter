...
{
HX_STACK_FRAME("openfl.display3D._Context3D.SamplerState","new",0xe10565af,"openfl.display3D._Context3D.SamplerState.new","openfl/display3D/Context3D.hx",1096,0xc899cbb9)
HX_STACK_THIS(this)
{
}
;
