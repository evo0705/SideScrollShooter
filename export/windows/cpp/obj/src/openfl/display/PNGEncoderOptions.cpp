...
bool PNGEncoderOptions_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void PNGEncoderOptions_obj::__register()
{
	...
	__mClass->mSetStaticField = &PNGEncoderOptions_obj::__SetStatic;
