...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("openfl.display.StageScaleMode","\x59","\x22","\xc5","\xbc"), hx::TCanCast< StageScaleMode_obj >,sStaticFields,sMemberFields,
