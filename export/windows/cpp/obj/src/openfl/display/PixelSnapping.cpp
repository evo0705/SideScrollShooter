...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("openfl.display.PixelSnapping","\xb8","\xbf","\x6e","\xcc"), hx::TCanCast< PixelSnapping_obj >,sStaticFields,sMemberFields,
