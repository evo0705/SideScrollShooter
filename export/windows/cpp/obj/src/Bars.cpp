...
HX_STACK_ARG(Max,"Max")
{
	...
	HX_STACK_LINE(68)
	tmp19->scrollFactor->set((int)0,(int)0);
	HX_STACK_LINE(69)
	::flixel::text::FlxText tmp20 = this->_text;		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(69)
	tmp20->scale->set(((Float)0.25),((Float)0.25));
	HX_STACK_LINE(70)
	::flixel::text::FlxText tmp21 = this->_text;		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(70)
	tmp21->offset->set((int)220,(int)12);
	HX_STACK_LINE(71)
	bool tmp22 = (Bar == ::BarType_obj::AMMO);		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(71)
	if ((tmp22)){
		HX_STACK_LINE(72)
		::flixel::text::FlxText tmp23 = this->_text;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(72)
		tmp23->offset->set((int)222,(int)12);
	}
	HX_STACK_LINE(74)
	::flixel::text::FlxText tmp23 = this->_text;		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("Bars","update",0xb699f557,"Bars.update","Bars.hx",78,0x70fb8b5e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(78)
		this->super::update();
	}
...
{
		HX_STACK_FRAME("Bars","setCurrentValue",0xb6106e2c,"Bars.setCurrentValue","Bars.hx",81,0x70fb8b5e)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Bars","setMaxValue",0xb105f1e1,"Bars.setMaxValue","Bars.hx",87,0x70fb8b5e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Value,"Value")
		HX_STACK_LINE(88)
		::flixel::ui::FlxBar tmp = this->_barVal;		HX_STACK_VAR(tmp,"tmp");
