...
{
HX_STACK_FRAME("enemy.Bandit","new",0x8e533458,"enemy.Bandit.new","enemy/Bandit.hx",11,0xd22615f7)
HX_STACK_THIS(this)
...
Float Y = __o_Y.Default(0);
{
	...
	HX_STACK_LINE(27)
	{
		...
		struct _Function_2_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","enemy/Bandit.hx",27,0xd22615f7)
				{
	...
	HX_STACK_LINE(28)
	{
		...
		struct _Function_2_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","enemy/Bandit.hx",28,0xd22615f7)
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("enemy.Bandit","resetMaxHealth",0x04394d99,"enemy.Bandit.resetMaxHealth","enemy/Bandit.hx",50,0xd22615f7)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("enemy.Bandit","addHealth",0x62210b95,"enemy.Bandit.addHealth","enemy/Bandit.hx",54,0xd22615f7)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(55)
...
{
		HX_STACK_FRAME("enemy.Bandit","update",0x9672ed11,"enemy.Bandit.update","enemy/Bandit.hx",61,0xd22615f7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(62)
...
{
		HX_STACK_FRAME("enemy.Bandit","hurt",0xf68f7117,"enemy.Bandit.hurt","enemy/Bandit.hx",69,0xd22615f7)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("enemy.Bandit","destroy",0x94d2ecf2,"enemy.Bandit.destroy","enemy/Bandit.hx",77,0xd22615f7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(77)
		this->super::destroy();
	}
...
{
		HX_STACK_FRAME("enemy.Bandit","AIMovement",0x7e8a2d3f,"enemy.Bandit.AIMovement","enemy/Bandit.hx",80,0xd22615f7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(81)
...
{
		HX_STACK_FRAME("enemy.Bandit","moveLeft",0xbd42acc0,"enemy.Bandit.moveLeft","enemy/Bandit.hx",104,0xd22615f7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(105)
		::flixel::util::FlxPoint tmp = this->acceleration;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(105)
...
{
		HX_STACK_FRAME("enemy.Bandit","moveRight",0x54218903,"enemy.Bandit.moveRight","enemy/Bandit.hx",109,0xd22615f7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(110)
		::flixel::util::FlxPoint tmp = this->acceleration;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(110)
