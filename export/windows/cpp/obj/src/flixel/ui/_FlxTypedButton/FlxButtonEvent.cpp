...
bool FlxButtonEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void FlxButtonEvent_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxButtonEvent_obj::__SetStatic;
