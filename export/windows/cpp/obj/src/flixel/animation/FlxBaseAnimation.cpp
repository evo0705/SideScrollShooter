...
bool FlxBaseAnimation_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void FlxBaseAnimation_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxBaseAnimation_obj::__SetStatic;
