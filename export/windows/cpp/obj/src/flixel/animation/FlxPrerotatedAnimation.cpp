...
bool FlxPrerotatedAnimation_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void FlxPrerotatedAnimation_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxPrerotatedAnimation_obj::__SetStatic;
