...
bool DebuggerFrontEnd_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void DebuggerFrontEnd_obj::__register()
{
	...
	__mClass->mSetStaticField = &DebuggerFrontEnd_obj::__SetStatic;
