...
::flixel::_system::debug::LogStyle LogStyle_obj::NORMAL;

::flixel::_system::debug::LogStyle LogStyle_obj::WARNING;

::flixel::_system::debug::LogStyle LogStyle_obj::ERROR;

::flixel::_system::debug::LogStyle LogStyle_obj::NOTICE;

::flixel::_system::debug::LogStyle LogStyle_obj::CONSOLE;
...
bool LogStyle_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"ERROR") ) { ERROR=ioValue.Cast< ::flixel::_system::debug::LogStyle >(); return true; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"NORMAL") ) { NORMAL=ioValue.Cast< ::flixel::_system::debug::LogStyle >(); return true; }
		if (HX_FIELD_EQ(inName,"NOTICE") ) { NOTICE=ioValue.Cast< ::flixel::_system::debug::LogStyle >(); return true; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"WARNING") ) { WARNING=ioValue.Cast< ::flixel::_system::debug::LogStyle >(); return true; }
		if (HX_FIELD_EQ(inName,"CONSOLE") ) { CONSOLE=ioValue.Cast< ::flixel::_system::debug::LogStyle >(); return true; }
	}
	return false;
}
...
void LogStyle_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("callbackFunction","\xfd","\xcd","\x91","\x7e"));
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsObject /*::flixel::_system::debug::LogStyle*/ ,(void *) &LogStyle_obj::NORMAL,HX_HCSTRING("NORMAL","\x27","\x1e","\xec","\xe2")},
	{hx::fsObject /*::flixel::_system::debug::LogStyle*/ ,(void *) &LogStyle_obj::WARNING,HX_HCSTRING("WARNING","\x3c","\xae","\x9f","\x89")},
	{hx::fsObject /*::flixel::_system::debug::LogStyle*/ ,(void *) &LogStyle_obj::ERROR,HX_HCSTRING("ERROR","\xa8","\x03","\x18","\xf1")},
	{hx::fsObject /*::flixel::_system::debug::LogStyle*/ ,(void *) &LogStyle_obj::NOTICE,HX_HCSTRING("NOTICE","\x18","\x84","\x3b","\xe4")},
	{hx::fsObject /*::flixel::_system::debug::LogStyle*/ ,(void *) &LogStyle_obj::CONSOLE,HX_HCSTRING("CONSOLE","\x37","\xbf","\xa9","\x98")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void LogStyle_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.LogStyle","\xb5","\x4e","\xe8","\xff");
...
{
	NORMAL= ::flixel::_system::debug::LogStyle_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null());
	WARNING= ::flixel::_system::debug::LogStyle_obj::__new(HX_HCSTRING("[WARNING] ","\xa4","\xa2","\x0d","\x4e"),HX_HCSTRING("FFFF00","\x80","\x14","\x82","\x79"),(int)12,true,false,false,HX_HCSTRING("assets/sounds/beep","\x8d","\xda","\x00","\x76"),true,null());
	ERROR= ::flixel::_system::debug::LogStyle_obj::__new(HX_HCSTRING("[ERROR] ","\xd0","\x1f","\xcd","\xbe"),HX_HCSTRING("FF0000","\x40","\xb1","\xe6","\x6a"),(int)12,true,false,false,HX_HCSTRING("assets/sounds/beep","\x8d","\xda","\x00","\x76"),true,null());
	NOTICE= ::flixel::_system::debug::LogStyle_obj::__new(HX_HCSTRING("[NOTICE] ","\x96","\x5e","\x07","\x09"),HX_HCSTRING("008000","\xf8","\xb2","\x85","\xf9"),(int)12,true,null(),null(),null(),null(),null());
	CONSOLE= ::flixel::_system::debug::LogStyle_obj::__new(HX_HCSTRING("&#62; ","\x7e","\xad","\x6d","\x7c"),HX_HCSTRING("0000ff","\x40","\x2d","\x3c","\xf4"),(int)12,true,null(),null(),null(),null(),null());
}
