...
Void FlxSplash_obj::create( ){
{
		...
		HX_STACK_LINE(68)
		::String tmp28 = ::openfl::_legacy::text::TextFormatAlign_obj::CENTER;		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(68)
		dtf->align = tmp28;
		HX_STACK_LINE(69)
		::openfl::_legacy::text::TextField tmp29 = this->_text;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(69)
		::openfl::_legacy::text::TextFormat tmp30 = dtf;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(69)
		tmp29->set_defaultTextFormat(tmp30);
		HX_STACK_LINE(70)
		::openfl::_legacy::text::TextField tmp31 = this->_text;		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(70)
		tmp31->set_text(HX_HCSTRING("HaxeFlixel","\x42","\x8f","\x0c","\xac"));
		HX_STACK_LINE(71)
		::openfl::_legacy::display::MovieClip tmp32 = ::openfl::_legacy::Lib_obj::get_current();		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(71)
		::openfl::_legacy::display::Stage tmp33 = tmp32->get_stage();		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(71)
		::openfl::_legacy::text::TextField tmp34 = this->_text;		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(71)
		tmp33->addChild(tmp34);
		HX_STACK_LINE(73)
		int tmp35 = stageWidth;		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(73)
		int tmp36 = stageHeight;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(73)
		this->onResize(tmp35,tmp36);
		HX_STACK_LINE(76)
		::flixel::_system::frontEnds::SoundFrontEnd tmp37 = ::flixel::FlxG_obj::sound;		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(76)
		::openfl::_legacy::media::Sound tmp38;		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(76)
		{
			HX_STACK_LINE(76)
			...
			HX_STACK_LINE(76)
			::String tmp39 = (HX_HCSTRING("assets/sounds/flixel","\xbb","\x1d","\xbd","\x3f") + extension);		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(76)
			tmp38 = ::openfl::_legacy::Assets_obj::getSound(tmp39,null());
		}
		HX_STACK_LINE(76)
		::flixel::_system::FlxSound tmp39 = tmp37->__Field(HX_HCSTRING("load","\x26","\x9a","\xb7","\x47"), hx::paccDynamic )(tmp38,null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp39,"tmp39");
		HX_STACK_LINE(76)
		tmp39->__Field(HX_HCSTRING("play","\xf4","\x2d","\x5a","\x4a"), hx::paccDynamic )(null());
	}
return null();
}
