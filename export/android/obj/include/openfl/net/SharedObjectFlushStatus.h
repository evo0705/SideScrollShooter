...
class SharedObjectFlushStatus_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("openfl.net.SharedObjectFlushStatus","\x23","\xe3","\xe6","\x68"); }
		::String __ToString() const { return HX_HCSTRING("SharedObjectFlushStatus.","\xdc","\x43","\xb7","\x7b") + tag; }
