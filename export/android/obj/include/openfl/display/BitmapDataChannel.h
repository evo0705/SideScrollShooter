...
class HXCPP_CLASS_ATTRIBUTES  BitmapDataChannel_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="openfl.display.BitmapDataChannel")
		...
		::String __ToString() const { return HX_HCSTRING("BitmapDataChannel","\xea","\x4b","\x0d","\x00"); }
