...
class Orientation3D_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("openfl.geom.Orientation3D","\x4d","\x44","\xc1","\xe6"); }
		::String __ToString() const { return HX_HCSTRING("Orientation3D.","\xad","\xb5","\x82","\xd9") + tag; }
