...
HX_STACK_ARG(WID,"WID")
{
	...
	if ((tmp)){
		HX_STACK_LINE(64)
		{
			...
			HX_STACK_LINE(64)
			this->bulletAnimations = Array_obj< ::Dynamic >::__new().Add(cpp::ArrayBase_obj::__new().Add(HX_HCSTRING("fire","\xb6","\xd3","\xbb","\x43")).Add(Array_obj< int >::__new().Add((int)0)).Add((int)10).Add(true)).Add(cpp::ArrayBase_obj::__new().Add(HX_HCSTRING("kill","\x9e","\xdf","\x09","\x47")).Add(Array_obj< int >::__new().Add((int)1).Add((int)2).Add((int)3)).Add((int)10).Add(false));
			HX_STACK_LINE(64)
		...
		if ((tmp1)){
			...
			if ((tmp2)){
				HX_STACK_LINE(76)
				{
					...
					HX_STACK_LINE(76)
					this->animations = Array_obj< ::Dynamic >::__new().Add(cpp::ArrayBase_obj::__new().Add(HX_HCSTRING("idle","\x14","\xa7","\xb3","\x45")).Add(Array_obj< int >::__new().Add((int)2)).Add((int)3).Add(true)).Add(cpp::ArrayBase_obj::__new().Add(HX_HCSTRING("fire","\xb6","\xd3","\xbb","\x43")).Add(Array_obj< int >::__new().Add((int)3).Add((int)2).Add((int)2).Add((int)2).Add((int)2).Add((int)2).Add((int)2).Add((int)2).Add((int)2).Add((int)2)).Add((int)30).Add(false));
					HX_STACK_LINE(76)
					this->bulletWidth = (int)10;
					HX_STACK_LINE(76)
					this->bulletOffsetWidth = (int)26;
