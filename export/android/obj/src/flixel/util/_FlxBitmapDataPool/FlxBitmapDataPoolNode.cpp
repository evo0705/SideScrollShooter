...
bool FlxBitmapDataPoolNode_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void FlxBitmapDataPoolNode_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxBitmapDataPoolNode_obj::__SetStatic;
