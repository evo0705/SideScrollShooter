...
bool FlxSystemButton_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void FlxSystemButton_obj::__register()
{
	...
	__mClass->mSetStaticField = &FlxSystemButton_obj::__SetStatic;
