...
{
HX_STACK_FRAME("flixel.ui._FlxVirtualPad.GraphicUp","new",0x7a7ba94a,"flixel.ui._FlxVirtualPad.GraphicUp.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::ui::_FlxVirtualPad::GraphicUp_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicUp_obj > _result_ = new GraphicUp_obj();
...
bool GraphicUp_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsString,(void *) &GraphicUp_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
hx::Class GraphicUp_obj::__mClass;
...
void GraphicUp_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.ui._FlxVirtualPad.GraphicUp","\x58","\xfc","\x4e","\xf7");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &GraphicUp_obj::__GetStatic;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(sStaticFields);
	__mClass->mMembers = hx::Class_obj::dupFunctions(0 /* sMemberFields */);
	__mClass->mCanCast = hx::TCanCast< GraphicUp_obj >;
#ifdef HXCPP_VISIT_ALLOCS
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_ui__FlxVirtualPad_GraphicUp","\x8d","\xe6","\xbc","\x43");
}
