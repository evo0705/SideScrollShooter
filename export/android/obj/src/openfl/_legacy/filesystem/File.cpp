...
::String File_obj::lime_filesystem_get_special_dir( int which){
	...
	HX_STACK_LINE(124)
	Dynamic tmp = ::openfl::_legacy::filesystem::File_obj::jni_filesystem_get_special_dir;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(124)
	bool tmp1 = (tmp == null());		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(124)
	if ((tmp1)){
		HX_STACK_LINE(126)
		Dynamic tmp2 = ::openfl::_legacy::utils::JNI_obj::createStaticMethod(HX_HCSTRING("org/haxe/lime/GameActivity","\x1d","\x61","\xc7","\xa4"),HX_HCSTRING("getSpecialDir","\xca","\x40","\x26","\xca"),HX_HCSTRING("(I)Ljava/lang/String;","\xb2","\x39","\x23","\x81"),null(),null());		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(126)
		::openfl::_legacy::filesystem::File_obj::jni_filesystem_get_special_dir = tmp2;
	}
	HX_STACK_LINE(130)
	Dynamic tmp2 = ::openfl::_legacy::filesystem::File_obj::jni_filesystem_get_special_dir(which);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(130)
	return tmp2;
}
