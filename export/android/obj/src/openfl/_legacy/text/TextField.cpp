...
int TextField_obj::getLineOffset( int lineIndex){
	HX_STACK_FRAME("openfl._legacy.text.TextField","getLineOffset",0x9c398a7f,"openfl._legacy.text.TextField.getLineOffset","openfl/_legacy/text/TextField.hx",66,0xa9138a6d)
	HX_STACK_THIS(this)
...
::String TextField_obj::getLineText( int lineIndex){
	HX_STACK_FRAME("openfl._legacy.text.TextField","getLineText",0x4e7aec99,"openfl._legacy.text.TextField.getLineText","openfl/_legacy/text/TextField.hx",73,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lineIndex,"lineIndex")
	HX_STACK_LINE(75)
	Dynamic tmp = this->__handle;		HX_STACK_VAR(tmp,"tmp");
