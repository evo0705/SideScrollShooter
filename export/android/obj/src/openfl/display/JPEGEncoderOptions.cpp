...
bool JPEGEncoderOptions_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void JPEGEncoderOptions_obj::__register()
{
	...
	__mClass->mSetStaticField = &JPEGEncoderOptions_obj::__SetStatic;
