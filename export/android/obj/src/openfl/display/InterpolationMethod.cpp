...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("openfl.display.InterpolationMethod","\xfb","\x44","\x9a","\x19"), hx::TCanCast< InterpolationMethod_obj >,sStaticFields,sMemberFields,
