...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("openfl.text.TextFieldAutoSize","\xba","\xce","\x65","\x35"), hx::TCanCast< TextFieldAutoSize_obj >,sStaticFields,sMemberFields,
