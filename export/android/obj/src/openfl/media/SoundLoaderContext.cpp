...
bool SoundLoaderContext_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void SoundLoaderContext_obj::__register()
{
	...
	__mClass->mSetStaticField = &SoundLoaderContext_obj::__SetStatic;
