...
{
HX_STACK_FRAME("openfl.system.ApplicationDomain","new",0x87171265,"openfl.system.ApplicationDomain.new","openfl/system/ApplicationDomain.hx",12,0xc87242cb)
HX_STACK_THIS(this)
...
Dynamic ApplicationDomain_obj::getDefinition( ::String name){
	HX_STACK_FRAME("openfl.system.ApplicationDomain","getDefinition",0xdd020c0e,"openfl.system.ApplicationDomain.getDefinition","openfl/system/ApplicationDomain.hx",27,0xc87242cb)
	HX_STACK_THIS(this)
